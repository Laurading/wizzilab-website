            ...
            <section className='margin'>
                <div className='content-col'>
                    <div className='column-2'>
                        ...
                        <p>
                            Wizzilab répond aux besoins à l’aide des nouvelles générations de composants éléctroniques et les nouvelles technologies.
                        </p>
                        <p>
                            Comprendre les défis quotidiens dans les secteurs professionnels, publics ou privés, nous permet d’optimiser les processus, de réduire les risques et d’économiser les ressources.
                        </p>
                    </div>
                    <div className='column-2'>
                    </div>
                </div>
                <p>Pour Wizzilab il y a une opportunité technologique à saisir via :</p>
                <ul>
                    <li>
                        Les infrastructures disponibles, cellulaires et câblées qui sont adaptées pour une consommation d’énergie à haut débit d’application
                    </li>
                    <li>
                        Le monde de l’IoT, capable d’effectuer un travail de manière cohérente pendant des années
                    </li>
                </ul>
                <p>Nous déployons les capacités extraordinaires de l’IoT en maîtrisant des technologies et des systèmes de conception qui viennent répondre à des demandes spécifiques de nos clients.</p>
            </section>
