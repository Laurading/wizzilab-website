          ...
          <div className='content-col-contact'>
            <div className='column-3 left denim-bg'>
              <div className='content-col'>
                <div className='padding-tb'>
                  <h4 className='cultured mobile-hidden'>STARTER KIT</h4>
            ...
            <div className='column-3x2'>
              <div className='padding-contact'>
                {data && (
                  <h3 className='padding-top'>{data.header.contact.ordertitle}</h3>
                )}
              </div>
              <form method="post" onSubmit={(e) =>  SendMail(e,content)}>
                ...
                <div className='center'>
                  {data && (
                    <button type='submit'>{data.header.contact.order}</button>
                  )}
                </div>
