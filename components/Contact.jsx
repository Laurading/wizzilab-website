...
const Contact = (props) => {
  ...
  const SendMail = (data) => {
    ...
    myHeaders.append("Authorization", "Basic N2VlOTA1NTUyOWNhNThkNTNj.NTg1YjBlMWVkOGU0NTQ6ZDMzODMzZjhkOWFhYmY5NTkxNGRhM2U1YmQxNDg4Yzc=");
          ...
          <div className='column-3x2'>
            ...
            <div className='content-col-contact'>
              ...
              <div className='column-3 left'>
                ...
                <input type="text" placeholder="Téléphone" required onChange={(e) => setContent({ ...content, phoneNumber: e.target.value })} />
              </div>
            </div>
            <div className='padding-contact'>
            ...
            <div className='center'>
              <button type='submit' onClick={() => SendMail(content)} >Envoyer</button>
            </div>
